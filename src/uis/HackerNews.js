...
// import {handleFetchNews} from "../components/redux-thunk/newsSlice";
import { getNews, setLoading, setQuery } from "../sagas/news/newsSlice";
const HackerNews = () => {
  ...
  return (
    <div className="w-2/4 p-5 mx-auto mt-5 mb-5 bg-white rounded-lg shadow-md">
      <div className="flex mb-5 gap-x-5">
        ...
        />
        <button onClick={handleSetLoading}>click</button>
      </div>
      {loading && (
